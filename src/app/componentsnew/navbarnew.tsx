...
'>  
    <li className="inline-block mx-1 ">Home</li>
    <li className="inline-block mx-1 ">Shop</li>
    <li className="inline-block mx-1 ">Product</li>
    <li className="inline-block mx-1 ">Pages</li>
    <li className="inline-block mx-1 ">About</li>
    </ul>
